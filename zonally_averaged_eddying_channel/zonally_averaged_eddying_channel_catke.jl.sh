...
# Run Julia
cd /g/data/v45/nc3020/mesoscale-parametrization-OSM2022/zonally_averaged_eddying_channel

/g/data/v45/nc3020/julia/julia --color=yes --project zonally_averaged_eddying_channel_catke.jl > $PBS_JOBID.log
