...
∇_q_op = KernelFunctionOperation{Center, Center, Center}(∇_dot_qᶜ, grid, computed_dependencies=dependencies)
vb_op  = KernelFunctionOperation{Center, Face, Center}(diffusive_flux_y, grid, computed_dependencies=dependencies)
wb_op  = KernelFunctionOperation{Center, Center, Face}(diffusive_flux_z, grid, computed_dependencies=dependencies)
